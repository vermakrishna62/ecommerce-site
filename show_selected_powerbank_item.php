...
<body style="background: #F1F3F6;">
	...
	<div class="container bg-white mt-5 pt-5 mb-5 px-5 pb-5">
		...
		<?php 
			...
			$sql = "SELECT * FROM powerbank WHERE id = $id";
		...
		<div class="row">
			<div class="col text-center">
				<img src="images/accessories/powerbank/<?php echo $foldName; ?>/<?php echo $imgName; ?>" style="height: 460px;">
			</div>
		</div>
		...
		<div class="row mt-4 mb-4">
			...
			<div class="col-9">
				<div class="container" style="border : 2px solid lightgrey; border-radius: 0.5px;">
					...
					<div class="row my-2">
						<div class="col-4">		
							<h6>Charging Cable</h6>		
						</div>
						<div class="col-7 ml-4">
							<h6><span><?php echo $cable ; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $weight; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $capacity; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $batteryType; ?></span></h6>
						</div>
					</div>
