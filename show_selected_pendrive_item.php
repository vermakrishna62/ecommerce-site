	...
	<div class="container bg-white mt-5 pt-5 mb-5 px-5 pb-5">
		...
		<div class="row">
			<div class="col text-center">
				<img src="images/accessories/pendrives/<?php echo $foldName; ?>/<?php echo $imgName; ?>" style="height: 460px;">
			</div>
		</div>
			...
			<div class="col-9">
				<div class="container" style="border : 2px solid lightgrey; border-radius: 0.5px;">
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $storage ; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $material; ?></span></h6>
						</div>
					</div>
