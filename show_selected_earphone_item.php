	...
	<div class="container bg-white mt-5 pt-5 mb-5 px-5 pb-5">
		...
		<div class="row">
			...
			<div class="col-6 justify-content-center">
				<img src="images/accessories/earphones/<?php echo $foldName; ?>/<?php echo $imgName; ?>" style="height: 460px;">
			</div>
			<div class="col-2">
		...
		<div class="row mt-5">
			<div class="col-4"></div>
			<div class="col-6">
				<a href="addToCart.php?prodid=<?php echo $id; ?>&modname=<?php echo $modType; ?>&gadname=Accessories&prodprice=<?php echo $prod_price; ?>&imgName=<?php echo $imgName; ?>&cname=<?php echo $prodModel; ?>"  
			...
			<div class="col-9">
				<div class="container" style="border : 2px solid lightgrey; border-radius: 0.5px;">
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $withmic; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $connector; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $bluetooth ; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $waterResistant; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $battery ; ?></span></h6>
						</div>
					</div>
