        ...
        <div class="main-content">
            <div class="main">
                ...
                <details>
                    ...
                    <ul>
                        <li><a href="laptopData.php?mdname=acer">Acer</a></li>
                        <li><a href="laptopData.php?mdname=asus">Asus</a></li>
                        <li><a href="laptopData.php?mdname=dell">Dell</a></li>
                        <li><a href="laptopData.php?mdname=hp">Hp</a></li>
                    </ul>
                </details>
                ...
                <table class="styled-table" style="width: 63%;">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            <td><?php echo $id; ?></td>
                            <td><img src="images/gadget-frontview/<?php echo $img; ?>" style="height:70px; width: 95px;">
                            </td>
                            ...
                            <td><?php echo $processorBrand; ?></td>
                            <td><?php echo $processorName; ?></td>
                            <td><?php echo $generation; ?></td>
                            <td><?php echo $ram; ?></td>
                            <td><?php echo $hdd; ?></td>
                            <td><?php echo $osbit; ?></td>
                            <td><?php echo $os; ?></td>
