        ...
        <div class="main-content">
            <div class="main">
                ...
                <details>
                    ...
                    <ul>
                        <li><a href="mobileData.php?mdname=samsung">Samsung</a></li>
                        <li><a href="mobileData.php?mdname=vivo">Vivo</a></li>
                        <li><a href="mobileData.php?mdname=oppo">Oppo</a></li>
                        <li><a href="mobileData.php?mdname=redmi">Redmi</a></li>
                        <li><a href="mobileData.php?mdname=oneplus">Oneplus</a></li>
                    </ul>
                </details>
                ...
                <table class="styled-table" style="width: 63%;">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            <td><?php echo $id; ?></td>
                            <td><img src="images/gadget-frontview/<?php echo $img; ?>" style="height:60px; width: 35px;">
                            </td>
