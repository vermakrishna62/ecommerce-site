    ...
    <body id="body-pd">
        ...
        <div class="main-content">
            <div class="main">
                ...
                <h1><?php 
                            if($db_name == '')
                                echo "Television Product Data";
                            else
                                echo ucfirst($db_name)." LED Product Data"; 
                    ?></h1>
                ...
                <details>
                    ...
                    <ul>
                        <li><a href="televisionData.php?mdname=32inches">32 Inches</a></li>
                        <li><a href="televisionData.php?mdname=38inches">38 Inches</a></li>
                        <li><a href="televisionData.php?mdname=42inches">42 Inches</a></li>
                        <li><a href="televisionData.php?mdname=50inches">50 Inches</a></li>
                        <li><a href="televisionData.php?mdname=55inches">55 Inches</a></li>
                ...
                <table class="styled-table" style="width: 63%;">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            <td><?php echo $id; ?></td>
                            <td style="padding: 12px 16px;"><img src="images/gadget-frontview/<?php echo $img; ?>" style="height:70px; width: 95px;" >
                            </td>
