...
<head>
	...
	<title>Accessories Store: Buy Mobile Cables</title>
	<style type="text/css">
		h3 {
			color: #000;
			font-size: 26px;
...
<body style="background: #F1F3F6;">
	...
	<div class="container bg-white mt-5 pt-5 mb-5 px-5 pb-5">
		...
		<?php 
			...
			$sql = "SELECT * FROM cables WHERE Id = $id";
		...
		<div class="row">
			<div class="col text-center">
				<img src="images/accessories/mobilecables/<?php echo $foldName; ?>/<?php echo $imgName; ?>" style="height: 460px;">
			</div>				
		</div>
			...
			<div class="col-9">
				<div class="container" style="border : 2px solid lightgrey; border-radius: 0.5px;">
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $cableType; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $cableSpeed; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $connectorOne; ?></span></h6>
						</div>
					</div>
					...
					<div class="row my-2">
						...
						<div class="col-7 ml-4">
							<h6><span><?php echo $connectorTwo; ?></span></h6>
						</div>
					</div>
