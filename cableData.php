        ...
        <div class="main-content">
            <div class="main">
                ...
                <details>
                    ...
                    <ul>
                        <li><a href="cableData.php?mdname=cables">Cables</a></li>
                        <li><a href="chargerData.php?mdname=chargers">Chargers</a></li>
                        <li><a href="earphoneData.php?mdname=earphones">Earphones</a></li>
                        <li><a href="pendriveData.php?mdname=pendrive">Pendrive</a></li>
                        <li><a href="powerbankData.php?mdname=powerbank">Powerbank</a></li>
                    </ul>
                </details>
                    ...
                    <tbody>
                        <?php 
                            while($row = mysqli_fetch_assoc($ret))
                            {
                                ...
                                $cableSpeed = $row['Cable_Speed'];
                                $connectorOne = $row['Connector_One'];
                                $connectorTwo = $row['Connector_Two'];
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td><?php echo ucfirst($prodModel); ?></td>
                            <td><?php echo $length; ?></td>
                            <td><?php echo $prod_price; ?></td>
                            <td><?php echo $cableType; ?></td>
                            <td><?php echo $cableSpeed; ?></td>
                            <td><?php echo $connectorOne; ?></td>
                            <td><?php echo $connectorTwo; ?></td>
